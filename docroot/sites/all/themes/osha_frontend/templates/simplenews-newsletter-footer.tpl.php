...
<div style="border-top: 1px solid #004098; color: #666666; font-size: 11px; text-align: center;">
  <div style="background-color: #f5f5f5; font-family: Verdana,Helvetica,'Lucida Grande',Lucida,Arial,sans-serif; margin-top: 1px; padding: 10px 0;">
    <span style="font-size: 13px;"><?php print t('Occupational Safety and Health News &ndash; Europe'); ?></span>
    <span><?php print t('Brought to you by EU-OSHA.'); ?></span> <span style="font-style: normal; font-weight: bold;"><?php print t('Visit us at:'); ?></span> <?php print l(t('http://osha.europa.eu'), 'http://osha.europa.eu'); ?>
  </div>
